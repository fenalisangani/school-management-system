...
urlpatterns = [
    path('api/by-institution/<str:institution>/', api.api_institution_classes, name='api_institution_classes'),
    ...
    path('<int:pk>/students/', views.school_class_students, name='school_class_students'),
